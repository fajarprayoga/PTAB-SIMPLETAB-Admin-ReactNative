...
const ViewDepartemen =({navigation})=>{
                ...
                <ScrollView >
                    ...
                    <View style={{alignItems:'center'}}>
                        <View style={{width:'90%',paddingTop:10}}>
                            <Title title='Detail Departemen' paddingVertical={5}/>
                            <View style={styles.baseBoxShadow} >
                                <View style={styles.boxShadow} >
                                    <DataView title='Kode' txt='CUS00001'/>
                                    <DataView title='Nama Departemen' txt='Distribusi'/>
                                    <DataView title='Deskripsi' txt='Ditribusi sangatlah mantap'/>
                                </View>
                            </View>
                        </View>
                    </View>
